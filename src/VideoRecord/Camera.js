// this file serves the functionality of the record video has all the code related to it and the face detection functionality.
    ...
    return (
      <View style={{flex: 1, left: '50%', top: '2%'}}>
        <View style={styles.timer}>
          ...
          <Text style={styles.timerText}>faces:{this.state.faces.length}</Text>
        </View>
      </View>
    );
  }
