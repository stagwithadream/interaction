...
export default class CameraScreen extends React.Component {
  ...
  facesDetected = ({ faces }) => {console.log(faces.length);this.setState({ faces })};
  ...
  renderLandmarksOfFace(face) {
   // console.log("FaceID: " , face.faceID, "leftEye:", face.leftEyePosition,"rightEye:", face.rightEyePosition, "leftEar:", face.leftEarPosition);
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text>{this.state.faces.length}</Text>
